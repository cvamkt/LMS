...
function CreateCourse() {
    ...
    async function onFormSubmit(e) {
        ...
        try {
            const action = await dispatch(createNewCourse(userInput)); // Await the dispatch
            if (createNewCourse.fulfilled.match(action)) { // Check if the action is fulfilled
                setUserInput({
                    title: "",
                    category: "",
                    createdBy: "",
                ...
                // Handle rejected action or errors
